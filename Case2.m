...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
durationOfSimulation = 10000e-9; % in seconds
...
parameters.tvec = logspace(-14,log10(durationOfSimulation),6000);
...
% INITIAL CONDITION
parameters.alpha = 1e6; % absorption coefficient at the laser wavelength cm^-1
