...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
durationOfSimulation = 2000e-9; % in seconds
...
parameters.k1 = 1/500e-9;% bulk recombination rate in s^-1

% TOP SRH
parameters.Stop = 50;% Top surface rec. vel. in cm/s
parameters.Ntop = 0; % per cc

% Bottom SRH
parameters.Sbot = 25;% Bot. surface rec. vel. in cm/s
